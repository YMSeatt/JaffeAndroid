...
/**
 * A utility for handling Fernet encryption and decryption, designed for Hilt dependency injection.
...
class EncryptionUtil @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    /**
     * Retrieves the Fernet key from private app storage. If it doesn't exist,
