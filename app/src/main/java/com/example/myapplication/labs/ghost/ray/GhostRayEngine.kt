...
class GhostRayEngine(private val context: Context) : SensorEventListener {
    ...
    companion object {
         ...
         * Parity with Python/ghost_ray_analysis.py.
         *
         * @param intersectedId The ID of the student intersected, or null.
         * @param studentName The name of the student intersected, or null.
         * @return A formatted Markdown string.
         */
        fun generateRayReport(intersectedId: Long?, studentName: String?): String {
            ...
            report.append("**Target Locked:** ${studentName ?: "NONE"}\n")
            report.append("**Intersection ID:** ${intersectedId ?: "VOID"}\n")
