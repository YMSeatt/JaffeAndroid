                ...
                actions = {
                    ...
                    Box {
                        ...
                        DropdownMenu(
                            ...
                            Divider()
                            Text("Mode: ${sessionType.name.lowercase().replaceFirstChar { it.titlecase(Locale.getDefault()) }}", modifier = Modifier.padding(start = 16.dp, end = 16.dp, top = 8.dp, bottom = 8.dp))
