...
import com.example.myapplication.ui.components.TopAppBarActions
            ...
            TopAppBar(
                ...
                actions = {
                    TopAppBarActions(
                        ...
                        showSaveLayoutDialog = showSaveLayoutDialog,
                        onShowSaveLayoutDialogChange = { showSaveLayoutDialog = it },
                        showLoadLayoutDialog = showLoadLayoutDialog,
                        onShowLoadLayoutDialogChange = { showLoadLayoutDialog = it },
                        showExportDialog = showExportDialog,
                        onShowExportDialogChange = { showExportDialog = it },
                        showChangeBoxSizeDialog = showChangeBoxSizeDialog,
                        onShowChangeBoxSizeDialogChange = { showChangeBoxSizeDialog = it },
                        sessionType = sessionType,
                        onSessionTypeChange = { sessionType = it },
                        showBehaviorDialog = showBehaviorDialog,
                        onShowBehaviorDialogChange = { showBehaviorDialog = it },
                        showLogQuizScoreDialog = showLogQuizScoreDialog,
                        onShowLogQuizScoreDialogChange = { showLogQuizScoreDialog = it }
                    )
                }
            )
        },
