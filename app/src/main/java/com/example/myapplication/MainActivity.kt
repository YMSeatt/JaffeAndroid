                ...
                actions = {
                    ...
                    Box {
                        ...
                        DropdownMenu(expanded = showMoreMenu, onDismissRequest = { showMoreMenu = false }) {
                            DropdownMenuItem(text = { Text("Undo") }, onClick = { seatingChartViewModel.undo(); showMoreMenu = false })
                            DropdownMenuItem(text = { Text("Redo") }, onClick = { seatingChartViewModel.redo(); showMoreMenu = false })
