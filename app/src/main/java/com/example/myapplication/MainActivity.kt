...
class MainActivity : ComponentActivity() {
    ...
    val createDocumentLauncher = registerForActivityResult(
        ...
        uri?.let {
            settingsViewModel.pendingExportOptions?.let { options ->
        ...
        settingsViewModel.pendingExportOptions = null
    }
        ...
        Box(
            ...
            if (showExportDialog) {
                ExportDialog(viewModel = seatingChartViewModel, onDismissRequest = { showExportDialog = false }, onExport = { options, share ->
                    settingsViewModel.pendingExportOptions = options
                    if (share) {
