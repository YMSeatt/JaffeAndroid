...
class GhostOrbitEngineTest {
    ...
    private fun createMockStudent(id: Long, x: Float, y: Float): StudentUiItem {
        return StudentUiItem(
            ...
            // Initialize other mandatory fields with defaults
            ...
            backgroundColors = mutableStateOf(emptyList()),
            outlineColors = mutableStateOf(emptyList()),
            textColor = mutableStateOf(androidx.compose.ui.graphics.Color.Black),
            ...
            displayFontFamily = mutableStateOf("sans-serif"),
            displayFontSize = mutableStateOf(12.sp),
