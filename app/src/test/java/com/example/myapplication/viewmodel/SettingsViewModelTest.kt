...
class SettingsViewModelTest {
    ...
    fun setup() {
        ...
        coEvery { preferencesRepository.updateAutoSendEmailOnClose(any()) } answers {
        ...
        coEvery { preferencesRepository.updateEditModeEnabled(any()) } answers {
        ...
        every { preferencesRepository.defaultStudentBoxCornerRadiusFlow } returns flowOf(8)
